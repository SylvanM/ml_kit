...
const LOSS_LOOKUP_TABLE: [LossFunctionIdentifier; 1] = [LossFunctionIdentifier::Squared];
...
impl LossFunctionIdentifier {
    ...
    pub fn loss(
        self,
        prediction: &matrix_kit::dynamic::matrix::Matrix<f64>,
        target: &matrix_kit::dynamic::matrix::Matrix<f64>,
    ) -> f64 {
        match self {
