use std::{mem::transmute, os::macos::raw};
...
#[cfg(test)]
mod file_tests {
    use crate::utility::file_utility::{bytes_to_floats, bytes_to_u64s, floats_to_bytes, u64s_to_bytes};


    #[test]
    fn test_byte_conversion() {
        let float_vec = vec![0.3453, 0.3467245372, 123513.1462456257752];
        debug_assert_eq!(float_vec, bytes_to_floats(floats_to_bytes(float_vec.clone())));
