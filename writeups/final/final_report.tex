...
\begin{itemize}
    ...
    \begin{itemize}
        \item an implementation of Singular Value Decomposition (SVD)\ftntmk{}\footnotetext{SVD is the process of taking a matrix $A$ and 
        factoring it as $$A = U \Sigma V^\top$$ where $U$ and $V$ are orthogonal and $\Sigma$ is diagonal.},
